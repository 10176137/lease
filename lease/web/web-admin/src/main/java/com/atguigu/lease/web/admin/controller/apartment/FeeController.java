...
public class FeeController {
    ...
    public Result saveOrUpdateFeeValue(@RequestBody FeeValue feeValue) {
        // feeValue.setIsDeleted(Byte.valueOf("1"));
    ...
    public Result deleteFeeKeyById(@RequestParam Long feeKeyId) {
        ...
        feeKey.setId(feeKeyId);
        feeKeyService.update(feeKey,new LambdaUpdateWrapper<FeeKey>().set(FeeKey::getIsDeleted,1).eq(FeeKey::getId, feeKeyId));
        return Result.ok();
    }
    ...
    public Result deleteFeeValueById(@RequestParam Long id) {
        ...
        feeValue.setId(id);
        feeValueService.update(feeValue, new LambdaUpdateWrapper<FeeValue>().set(FeeValue::getIsDeleted,1).eq(FeeValue::getId, id));
        return Result.ok();
    }
}
