package com.atguigu.lease.common.jjwtutil;
...
public class JjwtUtil {
	...
	// 加密密文，私钥
	public static final String JWT_ADMIN = "admincreatetokenwithjwt1234567891145141919810";
	public static final String JWT_APP = "app";

	public static final int EXPIRE_TIME = 60 * 60 * 1000; // 一个小时
	public static SecretKey generalKey() {
		// 本地的密码解码
		byte[] encodedKey = Base64.decodeBase64(JWT_ADMIN);
		// 根据给定的字节数组使用AES加密算法构造一个密钥
		SecretKey key = new SecretKeySpec(encodedKey, 0, encodedKey.length, "HmacSHA256");
		return key;
	}

	// issuer签发者, audience jwt接受者 subject用户Id
	public String createJWT(String issuer, String audience, String subject, Map<String,String> claims) throws Exception {
		// 设置头部信息
